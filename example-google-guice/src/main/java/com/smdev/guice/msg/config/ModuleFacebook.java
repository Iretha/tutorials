...
public class ModuleFacebook extends ModuleBase {
	...
	protected void configure() {
		...
		install(new FactoryModuleBuilder().implement(User.class, FBUser.class)
				.implement(Message.class, FBMessage.class).build(DomainFactory.class));
		 ...
		 * implementation */
		bind(ActivityService.class).annotatedWith(FBType.class).to(FBActivityService.class)
				.in(Scopes.SINGLETON);
